...
let expenseChart = new Chart(ctx, {
    ...
    options: {} // TODO Fill in things here later -- Still confused on this, we did not go back and do anything with this. ORRRRR am i just realizing that this is where the things we type in are going. Like rent and other stuff like that.
})
